...
@section('content')
    ...
    <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        ...
        <div class="uk-width-large-10-10">
            <form action="{!! route('block_time_store') !!}" method="post" class="uk-form-stacked" id="user_edit_form">
                            ...
                            <div class="user_content">
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-2">
                                        ...
                                        <input class="md-input" type="text" onchange="checkdate(this)" data-uk-datepicker="{format:'YYYY-MM-DD'}" id="user_edit_uname_control" name="date" />
                                    </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-2">
                                        ...
                                        <input class="md-input" type="time" onchange="checkstarttime(this)" id="meeting_start" name="start_time" />
                                    </div>
                                ...
                                <div class="uk-grid" data-uk-grid-margin>
                                    <div class="uk-width-medium-1-2">
                                        ...
                                        <input class="md-input" type="time" onchange="checkendtime(this)" id="meeting_end" name="end_time" />
                                    </div>
