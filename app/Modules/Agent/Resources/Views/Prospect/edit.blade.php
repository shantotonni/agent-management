                                   ...
                                   {{ csrf_field() }}
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        <div class="uk-width-medium-1-2">
                                            ...
                                            <input  class="md-input" type="text" onchange="checkdate(this)" data-uk-datepicker="{format:'YYYY-MM-DD'}"  id="datepicker" value="{{ $pros->timetable->date }}" name="mdate" required />
                                        </div>
